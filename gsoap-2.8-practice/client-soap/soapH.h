/* soapH.h
   Generated by gSOAP 2.8.54 for ../cal.h
...
{
	if (soap_GET(soap, URL, NULL) || soap_read_ns__add(soap, p) || soap_closesock(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
...
{
	if (soap_read_ns__add(soap, p) || soap_closesock(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
#endif
...
{
	if (soap_GET(soap, URL, NULL) || soap_read_ns__addResponse(soap, p) || soap_closesock(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
...
{
	if (soap_read_ns__addResponse(soap, p) || soap_closesock(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
#endif
